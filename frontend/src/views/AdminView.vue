...
import { fetchAdminStats, refreshAdminStats, type AdminStats } from '@/api'
...
<template>
  <div class="page" v-loading="loading">
    ...
    <el-card shadow="never">
      ...
      <el-table :data="stats?.packages ?? []" stripe max-height="420">
        ...
        <el-table-column prop="file_count" :label="t('packages.files')" width="100" align="right" sortable />
        ...
        <el-table-column prop="download_count" :label="t('packages.downloads')" width="120" align="right" sortable />
        <el-table-column prop="upload_count" :label="t('packages.uploads')" width="110" align="right" sortable />
      </el-table>
    </el-card>

    <el-card shadow="never">
      <template #header><span class="card-title">{{ t('admin.keysTitle') }}</span></template>
      <el-table :data="stats?.keys ?? []" stripe max-height="360">
        ...
        <el-table-column prop="download_count" :label="t('keys.table.downloads')" width="120" align="right" sortable />
        <el-table-column prop="upload_count" :label="t('keys.table.uploads')" width="110" align="right" sortable />
